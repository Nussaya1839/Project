...
public class PuzzleKitchen1 extends AppCompatActivity {
    ImageView imv1, imv2, imv3;
    ImageView imA, imE, imO, imU;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puzzle_kitchen1);
    ...
    private void delay() {
        ...
        myhandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent nextquest = new Intent(getApplicationContext(), PuzzleKitchen2.class);
