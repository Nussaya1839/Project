...
public class PuzzleNatural1 extends AppCompatActivity {
    ImageView imv1, imv2, imv3;
    ImageView imA, imE, imR, imY;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puzzle_natural1);
    ...
    private void delay() {
        ...
        myhandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent nextquest = new Intent(getApplicationContext(), PuzzleNatural2.class);
