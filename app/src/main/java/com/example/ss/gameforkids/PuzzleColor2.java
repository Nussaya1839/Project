...
public class PuzzleColor2 extends AppCompatActivity {
    ImageView imv1, imv2, imv3, imv4;
    ImageView imE, imA, imU, imS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puzzle_color2);
    ...
    private void delay() {
        ...
        myhandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent nextquest = new Intent(getApplicationContext(), PuzzleColor3.class);
