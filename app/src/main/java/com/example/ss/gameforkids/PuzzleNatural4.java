...
public class PuzzleNatural4 extends AppCompatActivity {
    ImageView imv1, imv2, imv3;
    ImageView imA, imE, imI, imO;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puzzle_natural4);
    ...
    private void delay() {
        ...
        myhandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent nextquest = new Intent(getApplicationContext(), PuzzleNatural5.class);
