...
public class PuzzleFood2 extends AppCompatActivity {
    ImageView imv1, imv2, imv3, imv4;
    ImageView imP, imB, imT, imK;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puzzle_food2);
    ...
    private void delay() {
        ...
        myhandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent nextquest = new Intent(getApplicationContext(), PuzzleFood3.class);
