...
public class PuzzleTool8 extends AppCompatActivity {
    ImageView imv1, imv2, imv3, imv4, imv5, imv6;
    ImageView imA, imE, imI, imU;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puzzle_tool8);
    ...
    private void delay() {
        ...
        myhandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent nextquest = new Intent(getApplicationContext(), PuzzleTool9.class);
