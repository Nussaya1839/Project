...
public class PuzzleFood3 extends AppCompatActivity {
    ImageView imv1, imv2, imv3, imv4;
    ImageView imU, imO, imI, imR;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puzzle_food3);
    ...
    private void delay() {
        ...
        myhandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent nextquest = new Intent(getApplicationContext(), PuzzleFood4.class);
