...
public class PuzzleBody2 extends AppCompatActivity {
    ImageView imv1, imv2, imv3;
    ImageView imA, imY, imE, imI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puzzle_body2);
    ...
    private void delay() {
        ...
        myhandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent nextquest = new Intent(getApplicationContext(), PuzzleBody3.class);
