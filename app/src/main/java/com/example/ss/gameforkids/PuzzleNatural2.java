...
public class PuzzleNatural2 extends AppCompatActivity {
    ImageView imv1, imv2, imv3;
    ImageView imA, imE, imI, imY;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puzzle_natural2);
    ...
    private void delay() {
        ...
        myhandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent nextquest = new Intent(getApplicationContext(), PuzzleNatural3.class);
