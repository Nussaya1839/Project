...
public class PuzzleColor4 extends AppCompatActivity {
    ImageView imv1, imv2, imv3, imv4;
    ImageView imE, imA, imO, imU;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puzzle_color4);
    ...
    private void delay() {
        ...
        myhandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent nextquest = new Intent(getApplicationContext(), PuzzleColor5.class);
