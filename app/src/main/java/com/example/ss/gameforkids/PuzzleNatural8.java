...
public class PuzzleNatural8 extends AppCompatActivity {
    ImageView imv1, imv2, imv3, imv4;
    ImageView imU, imE, imA, imI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puzzle_natural8);
    ...
    private void delay() {
        ...
        myhandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent nextquest = new Intent(getApplicationContext(), PuzzleNatural9.class);
