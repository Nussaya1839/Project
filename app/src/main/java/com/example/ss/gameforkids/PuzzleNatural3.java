...
public class PuzzleNatural3 extends AppCompatActivity {
    ImageView imv1, imv2, imv3;
    ImageView imA, imE, imU, imO;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puzzle_natural3);
    ...
    private void delay() {
        ...
        myhandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent nextquest = new Intent(getApplicationContext(), PuzzleNatural4.class);
